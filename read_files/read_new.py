...
print("-> hasOS_Name ", hasOS_Name_Counter, " ", len(hasOS_Name_list), " ", len(Counter(hasOS_Name_list).keys()))
count1 = 0
count2 = 0
...
print("-> hasGeometry ", hasGeometry_Counter, " ", len(hasGeometry_list), " ", len(Counter(hasGeometry_list).keys()))
count1 = 0
count2 = 0
