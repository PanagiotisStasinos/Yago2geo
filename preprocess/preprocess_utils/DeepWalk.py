...
#
#
# def skip_gram(file_path, num_of_steps, num_of_walks, skip_gram_window, window_size):
...
#     df.to_csv("../datasets/center_distance/window_size_" + str(window_size) + "/" + str(num_of_steps) + "steps_" +
#               str(num_of_walks) + "walks/my_skip_gram/skip_gram_vectors.csv", index=True)
